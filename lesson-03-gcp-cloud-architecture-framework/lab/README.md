# Lab: GCP Cloud Architecture Framework — Cross-Cloud Translation

## Overview

This lab builds practical fluency in mapping between AWS Well-Architected and GCP Cloud Architecture Framework concepts. You will compare the frameworks side-by-side, then translate a real AWS architecture into its GCP equivalent.

## Prerequisites

- Completed Lesson 03 lecture on GCP Cloud Architecture Framework
- Familiarity with AWS Well-Architected Framework (Lesson 02)
- Basic understanding of 3-tier web application architecture
...
4. Check your answers against the solution section
